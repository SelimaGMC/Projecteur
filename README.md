...
```
cd existing_repo
git remote add origin https://gitlab.utc.fr/epeterhe/rag_lo17.git
git branch -M main
...
* [Set up project integrations](https://gitlab.utc.fr/epeterhe/rag_lo17/-/settings/integrations)
